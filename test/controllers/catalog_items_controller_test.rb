...
class CatalogItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create catalog_item" do
    assert_difference('CatalogItem.count') do
      post catalog_items_url, params: { catalog_item: { description: @catalog_item.description, name: @catalog_item.name, price: @catalog_item.price } }
    end
  ...
  test "should update catalog_item" do
    patch catalog_item_url(@catalog_item), params: { catalog_item: { description: @catalog_item.description, name: @catalog_item.name, price: @catalog_item.price } }
