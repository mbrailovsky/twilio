Feature: Employer Agent Web Services Enrollment
	1. Enroll web Services Employer Agent
	...
	9. Login to eVerify as an Agent Program Administrator and validate new client activation (Scenario 61)
...
Scenario: 03- Set Employer Access-Y Agent-Y Corporate-N Web Services-Y
	Given the page is loaded
...
Scenario: 10-Add MOU Signatory
	Given the page is loaded
	When I set the text box using element id "ucMouPoc_ltLastName_TextBox" with the value "Zahedt"
	And I set the text box using element id "ucMouPoc_ltFirstName_TextBox" with the value "John"
...
Scenario: 11- Enter Company Information
	Given the page is loaded
	When I set the text box using element id "ucCompanyInfo_txtEmpName_TextBox" with the value "Variq Web Service"
	...
	And I set the text box using element id "ucCompanyInfo_ltnEmployerId_TextBox" with the value "128888888"
...
Scenario: 12-Generate NAIC Code
	Given the page is loaded
	When I set the text box using element id "ucNaics_ltNaicsCode_TextBox" with the value "221"
...
Scenario: 15-Add a Second Program Administrators
	Given the page is loaded
...
Scenario: 20- Set Employer Access-Y Agent-Y Corporate-N Web Services-Y
	Given the page is loaded
	When I click on the radio button using element id "radBpYes"
	And I click on the radio button using element id "radDaYes"
	And I click on the radio button using element id "radCorpNo"
...
Scenario: 32-Add a Second Program Administrators
	Given the page is loaded
	When I set the text box using element id "ucRegContacts_rptContacts__ctl0_ltLastName_TextBox" with the value "Test-Smith"
	And I set the text box using element id "ucRegContacts_rptContacts__ctl0_ltFirstName_TextBox" with the value "Frist-Name"
	And I set the text box using element id "ucRegContacts_rptContacts__ctl0_scPhone_PhoneAreaCode" with the value "777"
...
Scenario: 36-Search Company
	...
	And I set the text box using element id "txtEmployer_TextBox" with the value "Variq Web Service"
...
Scenario: 39-Company Details page
...
Scenario Outline: 40-Verify the Access Method
	Given the page is loaded
	Then the page contains the text <TextOnPage> from the following table
...
Scenario: 41-Set MOU Signed Date to Activate User
      Given the page title is "Company Details"
	  When I set the text box using element id "ucCompanyAccess_cdtMOUDate_dateTextBox" with the value "01/02/2016"
...
Scenario: 42-Edit Active User and Save User ID
	Given the page title is "Company Details"
...
Scenario: 43-Edit User, Set Tutorial Complete and Set Temp Password
	Given the page is loaded
...
Scenario: 48- Set Organization Designation
	Given the page is loaded
...
Scenario: 49-Add Client Information
	Given the page is loaded
	When I set the text box using element id "MainContentPlaceHolder_CompanyInformation1_txtEmpName_TextBox" with the value "One Test Client"
...
Scenario: 50-Add NAIC Code for New Client
	Given the page is loaded
...
Scenario: 52-Enter Program Administrator information
	Given the page is loaded
...
Scenario: 53-Verify POC Summary
	Given the page is loaded
...
Scenario Outline: 58- Verify newly created RWD Client
	Given the page is loaded
...
Scenario: 59-Logon to WebHQ and search for new client
	Given I navigate to the url for "webhq" titled "Login"
	When I set the checkbox with element id "cb_Iagree" to "true"
	And I click on the button using element id "btnContinue1"
	And I set the text box using element id "txtUserID" with the value for "webhq-username"
	...
	And the page title is "Company Search"
	And I set the text box using element id "txtEmployer_TextBox" with the value "One Test Client"
	And I click on the submit button labeled "Display Company Summary List"
	Then the page title is "Company Summary List"
...
Scenario: 61-Finally logon to eVerify and validate new client activation
	...
	And table row number "3" column number "2" contains the value "One Test Client"
